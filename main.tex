...
La complessità dell'attacco dell'avversario, tuttavia, diventa solo $2^{118}$ e non $2^{56 \cdot 3}$. \\
...
$$E(e_1, E(e_2, p))$$
L'avversario potrebbe provare ad effettuare un attacco bruteforce sulle chiavi, quindi in tal caso si troverà a generare $2^{56 \cdot 2}$ chiavi.
...
Nella decifratura si hanno i medesimi blocchi, solo che le chiavi sono schedulate al contrario: $k_{16}$ in R1 e $k_{15}$ in R2.
\begin{figure}[H]
	\centering
...
Possiamo forgiare l'HMAC firmando un messaggio: $m^0 = m||padding||w$
\begin{figure}[H]
	\centering
